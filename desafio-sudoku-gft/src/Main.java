...
public class Main {
    ...
    private final static Scanner scanner = new Scanner(System.in, "UTF-8");
    ...
    private static void clearGame() {
        ...
        if(confirm.equalsIgnoreCase("sim")){
            ...
            System.out.println("okay, o jogo não será resetado.");
        }
    }
    ...
    private static void finishGame() {
        ...
        if (board.gameIsFinished()){
            ...
            System.out.println("Seu jogo contêm, erros, verifique seu board e ajuste-o");
        } else {
    ...
    private static int runUntilGetValidNumber(final int min, final int max){
        try {
            ...
            scanner.next();
            int test = runUntilGetValidNumber(min, max);
            return test;
        }
    }
}